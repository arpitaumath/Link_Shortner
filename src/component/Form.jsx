    ...
    <>
       <div className=' w-full  flex flex-col items-center justify-center text-white pt-40 pb-10'>
            ...
            <form className='w-3/4 mt-10' onSubmit={handleSubmit}>
              <input className='h-14 w-2/3 rounded-l-md outline-none text-black px-5 placeholder:text-black' placeholder='Enter the link ' onChange={(e) => setText(e.target.value)} value={text}     />
